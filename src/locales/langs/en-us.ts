const enUS = {
  ...
  route: {
    ...
    publish_cluster: 'Cluster Management',
    publish_cluster_k8s: 'K8s Clusters',
    publish_cluster_linux: 'Linux Nodes',
    publish_container_k8s: 'K8s Clusters',
    publish_container_linux: 'Linux Nodes',
    publish_container_list: 'Container List',
    publish_container_history: 'Operation History',
    gateway: 'Gateway',
